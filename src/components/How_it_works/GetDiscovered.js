          ...
          <div className="w-[80%] col-span-2 ml-auto">
            <div className="pt-[80px]">
              ...
              <div className="text-[23px] text-[#898A8D] pb-[30px] w-[90%]">
                <div>
                  Let your work speak for itself. Resuss helps you stay visible
                  to producers, collaborators, and employers actively looking
                  for your skillset.
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start md:gap-6 pt-[60px] px-6 md:px-12">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="text-[18px] text-[#898A8D]">
                Let your work speak for itself. Resuss helps you stay visible to
                producers, collaborators, and employers actively looking for
                your skillset.
              </div>
            </div>
          </div>
